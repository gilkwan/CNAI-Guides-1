...
Welcome gilkwan to Open Liberty! In order to contribute a guide for Open Liberty, follow the steps in this README.
...
// INSTRUCTION: Update the SEO desciption for the guide
...
[source, Java]
----
include::finish/src/main/java/io/openliberty/guides/todolistSample/managers/samples/SampleTodoManager.java[tags=**;]
----
